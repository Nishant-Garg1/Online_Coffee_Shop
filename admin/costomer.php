...
<body>
    ...
    <h2 style="text-align: center; margin:10px;">Our Customer</h2>
...
<div>
      ...
      <div >
        <button type="submit" name="costomer_submit">Save</button>
        </div>
      </form>
...
while($ans=mysqli_fetch_array($sq)){
        ...
        <tr>
            ...
            <td> <a href="cupdate.php?id=<?php echo $ans['id'] ?>">Update</a></td>
