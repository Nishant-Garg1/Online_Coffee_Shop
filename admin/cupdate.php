...
<body>
    ...
    <h2 style="text-align: center; margin:10px;">Customer Update</h2>
...
if(isset($_POST['costomer_submit'])){
    ...
    $update="update costomer set img='$img_name',title='$title',des='$des' where id='$id'";
...
<div>
      ...
      <div >
        <button type="submit" name="costomer_submit">Update</button>
        </div>
      </form>