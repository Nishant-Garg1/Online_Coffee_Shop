...
<body>
    ...
    <h2 style="text-align: center; margin:10px;">Our Product</h2>
...
<div>
        <label for="">Price</label>
            <input type="texr" name="price" autocomplete="off" class="form-control">
</div>


       
      <div >
        <button type="submit" name="product_submit">Save</button>
        </div>
      </form>
...
while($ans=mysqli_fetch_array($sq)){
        ...
        <tr>
            ...
            <td> <a href="pupdate.php?id=<?php echo $ans['id'] ?>">Update</a></td>
